...
export default function PrivacyPolicy() {
  return (
    <section>
      ...
      <p>
        Wir freuen uns über Ihr Interesse an Ciceroic, der Plattform fürs Reden
        lernen. Der Schutz Ihrer Privatsphäre ist für uns sehr wichtig.
      ...
      <p>
        ...
        Dienste zum Hosting und zur Darstellung der Webseite und App. Dies dient
        ...
        Alle Daten, die im Rahmen der Nutzung dieser App, Webseite oder in dafür
        vorgesehenen Formularen im Onlineshop wie folgend beschrieben erhoben
        werden, werden auf seinen Servern verarbeitet. Eine Verarbeitung auf
        anderen Servern findet nur in dem hier erläuterten Rahmen statt. Dieser
        Dienstleister sitzt innerhalb eines Landes der Europäischen Union oder
        des Europäischen Wirtschaftsraums.
      </p>
      <p>
        <h3>2. Datenerhebung und -verwendung zur Vertragsabwicklung</h3> Wir
        erheben personenbezogene Daten, wenn Sie uns diese im Rahmen Ihrer
        Registrierung, Bestellung oder bei einer Kontaktaufnahme mit uns (z.B.
        per Kontaktformular oder E-Mail) mitteilen. Pflichtfelder werden als
        ...
        aus den jeweiligen Eingabeformularen ersichtlich. Wir verwenden die von
        ...
        eingeschränkt und nach Ablauf etwaiger steuer- und handelsrechtlichen
      ...
      <p>
        <h3>3. Datenweitergabe</h3> Zur Vertragserfüllung gemäß Art. 6 Abs. 1 S.
        1 lit. b DSGVO unserer Dienste der App und Website, speichern wir
        personenbezogene Nutzerdaten bei Drittanbietern und geben
        personenbezogene Daten zur weiteren Erfüllung an Drittanbietern weiter.
        Ihre Daten speichern für bei Drittanbietern auf den Datenbanken, die die
        technische Realisierung und Funktionsfähigkeit der App und Website
        notwendig machen. Wir geben Ihre Daten an das mit der Lieferung
        ...
        Datenweitergabe an Versanddienstleister Sofern Sie uns hierzu während
        oder nach Ihrer Bestellung Ihre ausdrückliche Einwilligung erteilt
        haben, geben wir aufgrund dieser gemäß Art. 6 Abs. 1 S. 1 lit. a DSGVO
        Ihre E-Mail-Adresse an den ausgewählten Versanddienstleister weiter,
        damit dieser vor Zustellung zum Zwecke der Lieferungsankündigung bzw.
        ...
        Kontaktmöglichkeit unter der im Folgenden aufgeführten Kontaktadresse
        widerrufen werden. Nach Widerruf löschen wir Ihre hierfür angegebenen
        Daten, soweit Sie nicht ausdrücklich in eine weitere Nutzung Ihrer Daten
        ...
        <a href="mailto:kontakt@ciceroic.com">kontakt@ciceroic.com</a>
      </p>
      <h3>4. E-Mail-Newsletter</h3>
      <h4>E-Mail-Werbung mit Anmeldung zum Newsletter</h4>
      <p>
      ...
      <p>
        ...
        über einen dafür vorgesehenen Link im Newsletter erfolgen. Nach
        Abmeldung löschen wir Ihre E-Mail-Adresse, soweit Sie nicht ausdrücklich
      ...
      <p>
        ...
        oder Dienstleistung erhalten und Sie dem nicht widersprochen haben,
      ...
      <p>
        ...
        dafür vorgesehenen Link in der Werbemail widersprechen, ohne dass
        hierfür andere als die Übermittlungskosten nach den Basistarifen
        entstehen.
      </p>
      <p>
        Der Newsletter kann im Rahmen einer Verarbeitung in unserem Auftrag
        durch einen Dienstleister versendet werden, an den wir Ihre
        E-Mail-Adresse hierzu weitergeben. Die Versendung findet über die
        Dienste eines Drittanbieters statt.
      </p>
      <p>
        Diese Dienstleister sitzt innerhalb eines Landes der Europäischen Union
        oder des Europäischen Wirtschaftsraums.
      </p>
      <h3>5. Cookies, Webanalyse und Werbezwecke</h3>
      ...
      <h4>
        Einsatz von Google (Universal) Analytics zur Webanalyse und zu
        Werbezwecken
      </h4>
      <p>
        Zur Webseitenanalyse setzt diese Website Google (Universal) Analytics
        ein, einen Webanalysedienst der Google LLC (www.google.de). Dies dient
        der Wahrung unserer im Rahmen einer Interessensabwägung überwiegenden
        berechtigten Interessen an einer optimierten Darstellung unseres
        Angebots gemäß Art. 6 Abs. 1 S. 1 lit. f DSGVO. Wir verwenden Google
        Analytics weiterhin zur Optimierung und zur Evaluation unser
        Online-Marketing-Maßnahmen. Google (Universal) Analytics verwendet
        Methoden, die eine Analyse der Benutzung der Website durch Sie
        ermöglichen, wie zum Beispiel Cookies. Die automatisch erhobenen
        Informationen über Ihre Benutzung dieser Website werden in der Regel an
        einen Server von Google in den USA übertragen und dort gespeichert.
        Durch die Aktivierung der IP-Anonymisierung auf dieser Webseite wird
        dabei die IP-Adresse vor der Übermittlung innerhalb der Mitgliedstaaten
        ...
        Ihrem Browser übermittelte anonymisierte IP-Adresse wird grundsätzlich
        nicht mit anderen Daten von Google zusammengeführt. Nach Zweckfortfall
        und Ende des Einsatzes von Google Analytics durch uns werden die in
        diesem Zusammenhang erhobenen Daten gelöscht.
      </p>
      <p>
        Die Google LLC hat ihren Hauptsitz in den USA und ist zertifiziert unter
        dem EU-US-Privacy Shield. Ein aktuelles Zertifikat kann hier eingesehen
      ...
      <p>
        ...
        geographischen Informationen Google Maps wird von Google LLC, 1600
        Amphitheatre Parkway, Mountain View, CA 94043, USA (nachfolgend: Google)
        betrieben. Dies dient der Wahrung unserer im Rahmen einer
        Interessensabwägung überwiegenden berechtigten Interessen an einer
        optimierten Darstellung unseres Angebots sowie einer leichten
        Erreichbarkeit unserer Standorte gemäß Art. 6 Abs. 1 lit. f) DSGVO.
      </p>
      <p>
        Bei der Verwendung von Google Maps werden von Google Daten über die
        Nutzung der Maps-Funktionen durch Webseitenbesucher übermittelt bzw.
        verarbeitet, wozu insbesondere die IP-Adresse sowie Standortdaten
        gehören können. Wir haben keinen Einfluss auf diese Datenverarbeitung.
      </p>
      <p>
        Google ist zertifiziert unter dem EU-US-Privacy Shield. Ein aktuelles
        Zertifikat kann hier eingesehen werden. Aufgrund dieses Abkommens
        zwischen den USA und der Europäischen Kommission hat letztere für unter
        dem Privacy Shield zertifizierte Unternehmen ein angemessenes
        Datenschutzniveau festgestellt.
      </p>
      <p>
        Um den Service von Google Maps zu deaktivieren und damit die
        Datenübermittlung an Google zu verhindern, müssen Sie die
        Java-Script-Funktion in Ihrem Browser deaktivieren. In diesem Fall kann
        Google Maps nicht bzw. nur eingeschränkt genutzt werden.
      </p>
      <p>
        Weitergehende Informationen über die Datenverarbeitung durch Google
        finden Sie in den Datenschutzhinweisen von
        <a href="http://www.google.com/privacypolicy.html">Google</a>. Die
        Nutzungsbedingungen für
        <a href="http://www.google.com/intl/de_de/help/terms_maps.html">
          Google Maps
        </a>
        beinhalten detaillierte Informationen zum Kartendienst.
      </p>
      ...
      <p>
        ...
        Google reCAPTCHA Service des Unternehmens Google LLC, 1600 Amphitheatre
        Parkway, Mountain View, CA 94043, USA (nachfolgend: Google) Durch die
        Überprüfung einer manuellen Eingabe verhindert dieser Dienst, dass
        automatisierte Software (sog. Bots) missbräuchliche Aktivitäten auf der
        Website ausführt. Dies dient gemäß Art. 6 Abs. 1 S. 1 lit. f DSGVO der
        Wahrung unserer im Rahmen einer Interessensabwägung überwiegenden
        berechtigten Interessen am Schutz unserer Webseite vor Missbrauch sowie
        an einer störungsfreien Darstellung unseres Onlineauftritts.
      </p>
      <p>
        ...
        Browser gespeicherte Cookies durch Google reCAPTCHA ausgewertet. Ein
        Auslesen oder Speichern von personenbezogenen Daten aus den
        Eingabefeldern des jeweiligen Formulars findet nicht statt.
      </p>
      <p>
        Google ist zertifiziert unter dem EU-US-Privacy Shield. Ein aktuelles
        Zertifikat kann <a href="https://www.privacyshield.gov/list">hier</a>
        ...
        festgestellt. Sie können die Erfassung der durch das JavaScript, bzw.
        ...
        durch Google verhindern, indem sie in Ihren Browser-Einstellungen die
        Ausführung von JavaScripten oder das Setzen von Cookies unterbinden.
        Bitte beachten Sie, dass dies die Funktionalität unseres Webangebots für
        Ihre Nutzung einschränken kann. Weitere Informationen zu der
        Datenschutzpolicy von Google finden Sie
        <a href="https://einguterplan.de/datenschutzbelehrung/www.google.com/policies/privacy/">
          hier
        </a>
        .
      </p>
      <h4>Google Fonts</h4>
      <p>
        Auf dieser Webseite ist der Script Code „Google Fonts“ des Unternehmens
        Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA
        (nachfolgend: Google) eingebunden. Dies dient der Wahrung unserer im
        Rahmen einer Interessensabwägung überwiegenden berechtigten Interessen
        an einer einheitlichen Darstellung der Inhalte auf unserer Webseite
        gemäß Art. 6 Abs. 1 lit. f) DSGVO.
      </p>
      <p>
        In diesem Rahmen wird eine Verbindung zwischen dem von Ihnen verwendeten
      ...
      <p>
        Weitergehende Informationen über die Datenverarbeitung durch Google
        finden Sie in den Datenschutzhinweisen von{' '}
        <a href="http://www.google.com/privacypolicy.html">Google</a>.
      </p>
      <h3>6. Social Media Plugins</h3>
      <p>
        Verwendung von Social Plugins von Facebook, Google Auf unserer Website
        werden sogenannte Social Plugins („Plugins“) von sozialen Netzwerken
        verwendet.{' '}
      </p>
      <p>
        ...
        Plugins wird vom jeweiligen Anbieter direkt an Ihren Browser übermittelt
        und in die Seite eingebunden. Durch die Einbindung der Plugins erhalten
        die Anbieter die Information, dass Ihr Browser die entsprechende Seite
        unseres Webauftritts aufgerufen hat, auch wenn Sie kein Profil besitzen
        oder gerade nicht eingeloggt sind. Diese Information (einschließlich
        Ihrer IP-Adresse) wird von Ihrem Browser direkt an einen Server des
        jeweiligen Anbieters (ggf. in die USA) übermittelt und dort gespeichert.
        Sind Sie bei einem der Dienste eingeloggt, können die Anbieter den
        Besuch unserer Website Ihrem Profil in dem jeweiligen sozialen Netzwerk
        unmittelbar zuordnen. Wenn Sie mit den Plugins interagieren, zum
        Beispiel den „Like“- oder den „Share“-Button betätigen, wird die
        entsprechende Information ebenfalls direkt an einen Server der Anbieter
        übermittelt und dort gespeichert. Die Informationen werden außerdem in
      ...
      <p>
        ...
        Nutzung der Daten durch die Anbieter sowie eine Kontaktmöglichkeit und
        Ihre diesbezüglichen Rechte und Einstellungsmöglichkeiten zum Schutz
        Ihrer Privatsphäre entnehmen Sie bitte den Datenschutzhinweisen der
        Anbieter.{' '}
      </p>
      <p>
        ...
        <br />
        <a href="http://www.google.com/intl/de/+/policy/+1button.html">
      ...
      <p>
        ...
        Abs. 1 lit. a DSGVO. Soweit die vorgenannten Social-Media Plattformen
        ihren Hauptsitz in den USA haben, gilt Folgendes: Für die USA liegt ein
        ...
        jeweilige Unternehmen kann hier eingesehen werden. Die detaillierten
        Informationen zur Verarbeitung und Nutzung der Daten durch die Anbieter
        auf deren Seiten sowie eine Kontaktmöglichkeit und Ihre diesbezüglichen
        Rechte und Einstellungsmöglichkeiten zum Schutz Ihrer Privatsphäre,
        insbesondere Widerspruchsmöglichkeiten (Opt-Out), entnehmen Sie bitte
        ...
        Facebook: https://www.facebook.com/about/privacy/ Die Datenverarbeitung
        erfolgt auf Grundlage einer Vereinbarung zwischen gemeinsam
        Verantwortlichen gemäß Art. 26 DSGVO, die Sie hier einsehen können:
        https://www.facebook.com/legal/terms/page_controller_addendum Instagram:
        http://instagram.com/about/legal/privacy/ Widerspruchsmöglichkeit
        (Opt-Out): Facebook: https://www.facebook.com/settings?tab=ads
        Instagram: http://instagram.com/about/legal/privacy/
      </p>
      <p>
        <h3>7. Kontaktmöglichkeiten und Ihre Rechte</h3> Als Betroffener haben
        Sie folgende Rechte:
        <ul>
          <li>
          ...
          <li>
            ...
            ist, Sie aber deren Löschung ablehnen; – wir die Daten nicht mehr
      ...
      <p>
        ...
        Rechtsansprüchen dient. Dies gilt nicht, wenn die Verarbeitung zu
